...
describe('Toguru Client Usage', () => {
  it('Basic usage', async () => {
    ...
    expect(
      client.isToggleEnabled('rolled-out-to-noone', userInBucket22CultureDE)
    ).toBe(false);
    expect(
    ...
    expect(
      client.isToggleEnabled('rolled-out-to-everyone', userInBucketb76CultureDE)
    ).toBe(true);
    expect(
      client.isToggleEnabled('rolled-out-only-in-de', userInBucket22CultureIT)
    ).toBe(false);
    expect(
  ...
  it('Advanced features', async () => {
    ...
    expect(
      client.togglesForService('service2', userInBucket22CultureDE)
    ).toEqual({
